...
export default [
  /* ====================== 4 · Appareils auditifs — prix ================== */
  {
    ...
    ar: {
      ...
      faq: [
        {
          q: 'كم سعر الجهاز السمعي (سماعة الأذن الطبية) في الدار البيضاء؟',
  ...
  /* ====================== 5 · La perte auditive ========================== */
  {
    ...
    ar: {
      ...
      description:
        'ضعف السمع: العلامات والأسباب، ومتى تستشير أو تحتاج إلى سماعات طبية. شرح مبسّط من أوديوليك، الدار البيضاء. للحجز: 05 22 39 37 98.',
      h1: 'فهم ضعف السمع',
      lede:
      ...
      sections: [
        ...
        },
        {
          ...
          p: [
            ...
            'ومن هنا العبارة التي نسمعها كثيرًا في المركز: «أسمع، لكنني لا أفهم». وهذا بالضبط ما يقيسه القياس الكلامي، إلى جانب مخطّط السمع (تخطيط السمع).',
          ],
        },
        {
