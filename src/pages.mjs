...
const core = [
     ...
     ====================================================================== */
  {
    ...
    ar: {
      ...
      description:
        'مركز تصحيح السمع بالدار البيضاء، الأميرات (المعاريف): فحص السمع، سماعات طبية وأجهزة سمعية، الضبط والمتابعة. بموعد: 05 22 39 37 98.',
      ...
      sections: [
        ...
        },
        {
          ...
          p: [
            'مركز على مقاس الإنسان، ونفس المُحاور، أخصائي السمع نفسه، من الفحص الأول إلى آخر ضبط. نجاح التجهيز السمعي يقوم على علاقة متواصلة: من قاس سمعك هو من يعرفك.',
          ],
          list: [
            ...
            'عرض سعر وفاتورة مطابقان لملف الاسترجاع',
          ],
        },
        {
          ...
          p: [
            ...
            '*الاختيار* — نقارن بين جهازين أو ثلاثة تناسب مخطّط سمعك (تخطيط السمع) وحياتك اليومية وميزانيتك.',
      ...
      faq: [
        ...
        },
        {
          ...
          a: 'على سبيل الإرشاد، وللجهاز الواحد: الفئة الأساسية ابتداءً من 5 000 درهم، وفئة الراحة من 7 000 إلى 12 000 درهم، وفئة بريميوم ابتداءً من 14 000 درهم. ويتوقّف السعر النهائي على حالة سمعك والطراز المختار، ويُذكر في عرض السعر المفصّل الذي تتسلّمه بعد الفحص، ولا توقيع في اليوم نفسه.',
        },
        {
