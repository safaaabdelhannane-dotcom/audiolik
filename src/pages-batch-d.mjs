...
export const batchD = [
     ...
     ====================================================================== */
  {
    ...
    ar: {
      ...
      description:
        'اختبار سمع أونلاين مجاني في ثلاث دقائق، دون تسجيل، قبل التفكير في سماعات طبية. AudioLik، الدار البيضاء. للحجز: 05 22 39 37 98.',
      ...
      sections: [
        ...
        },
        {
          h2: 'بعد الاختبار',
          p: [
            'إذا دعاك النتيجة إلى الاستشارة، فالخطوة التالية هي فحص السمع داخل المركز: حديث مع أخصائي السمع، فحص للقناة، قياس سمع نغمي ثم كلامي (تخطيط السمع)، وشرح للمنحنيات المحصّل عليها. هذا الفحص مجاني ودون التزام — ومن الممكن جدًا أن تخرج منه بجملة «سمعك بخير، عد بعد سنتين». وإن كانت الأجهزة السمعية (سماعات طبية) مفيدة لك، شرحنا لك السبب.',
     ...
     ====================================================================== */
  {
    ...
    ar: {
      ...
      description:
        'سماعات طبية وتعويضها بالمغرب (CNSS، CNOPS، AMO): الوثائق المطلوبة والمسطرة بالترتيب. AudioLik، الدار البيضاء: 05 22 39 37 98.',
      h1: 'استرجاع مصاريف السماعات الطبية بالمغرب',
      lede:
        'الأجهزة السمعية (سماعات طبية) تفتح، حسب نظامك، الحق في تكفّل جزئي. المبلغ يتوقّف على صندوقك وعلى ملفك — ولن نذكره هنا. أما المسطرة فهي واحدة دائمًا، وهي التي تربح لك أسابيع أو تضيّعها.',
      sections: [
        {
          h2: 'الأنظمة المعنية',
          p: [
            'بالمغرب، يمرّ التكفّل بالسمّاعة الطبية، أي تعويض جزء من ثمنها، عبر التأمين الإجباري الأساسي عن المرض (AMO). وحسب وضعيتك، يُدرَس ملفك لدى *الصندوق الوطني للضمان الاجتماعي (CNSS)* بالنسبة لأجراء القطاع الخاص والمستقلين، أو لدى *CNOPS* والتعاضديات بالنسبة لموظفي القطاع العام، أو لدى صندوق *القوات المسلحة الملكية* بالنسبة للعسكريين وذوي حقوقهم، أو عبر *تأمين أو تعاضدية للمقاولة* تكمّل النظام الأساسي.',
        ...
        },
        {
          ...
          list: [
            ...
            '*تقرير قياس السمع* أو تخطيط السمع (النغمي والكلامي)، مرفقًا بالمنحنيات',
        ...
        },
        {
          ...
          p: [
            ...
            'وإن لم تكن تعرف النظام الذي تنتمي إليه، أحضر بطاقة تسجيلك يوم الفحص: غالبًا ما تكفي لتحديد الجهة المخاطَبة وتوفير تنقّل لا لزوم له. ولأيّ سؤال عن ملف التعويض، اتصل بالمركز على [05 22 39 37 98](tel:+212522393798) خلال أوقات العمل.',
          ],
        },
      ],
      faq: [
