    ...
    ar: {
      ...
      sections: [
        ...
        },
        {
          h2: 'بعد الاختبار',
          p: [
            'إذا دعاك النتيجة إلى الاستشارة، فالخطوة التالية هي فحص السمع داخل المركز: حديث مع أخصائي السمع، فحص للقناة، قياس سمع نغمي ثم كلامي (تخطيط السمع)، وشرح للمنحنيات المحصّل عليها. هذا الفحص مجاني ودون التزام — ومن الممكن جدًا أن تخرج منه بجملة «سمعك بخير، عد بعد سنتين».',
